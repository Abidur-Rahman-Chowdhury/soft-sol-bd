...
<section id="home" class="no-padding">	
    	<div id="main-slide" class="cd-hero">
			<ul class="cd-hero-slider">
				<li class="selected">
					<div class="overlay2">
						<img class="" src="client/images/slider/bg1.jpg" alt="slider">
					</div>
				...
				<li>
					<div class="overlay2">
						<img class="" src="client/images/slider/bg2.jpg" alt="slider">
					</div>
					...
					<div class="cd-half-width cd-img-container">
						<img src="client/images/slider/bg-thumb1.png" alt="">
					</div> <!-- .cd-half-width.cd-img-container -->
				</li>
				<li>
					<div class="overlay2">
						<img class="" src="client/images/slider/bg3.jpg" alt="slider">
					</div>
					<div class="cd-half-width cd-img-container img-right">
						<img src="client/images/slider/bg-thumb2.png" alt="">
					</div> <!-- .cd-half-width.cd-img-container -->
					<div class="cd-half-width">
