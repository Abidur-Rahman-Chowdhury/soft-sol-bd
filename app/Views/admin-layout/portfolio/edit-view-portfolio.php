<div class="col-md-6 mx-auto">
  ...
  <div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form method="post" enctype="multipart/form-data" action="<?php echo site_url('admin/portfolio/update'); ?>">
      <input type="hidden" name="id" value="<?php echo $portfolio['id']; ?>">
      <div class="card-body">
        <div class="form-group">
          <label for="title">Title</label>
          <input type="text" value="<?php echo $portfolio['title']; ?>" class="form-control" id="title" name="title" placeholder="title">
        ...
        <div class="form-group">
          ...
          <input type="text" value="<?php echo $portfolio['meta_key_word']; ?>" class="form-control" id="MetaKeyWord" name="meta_key_word" placeholder="meta key word">
