...
<div class="col-md-6 mx-auto">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Edit Softsol Data</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form method="post" enctype='multipart/form-data' action="<?php echo site_url('admin/softsol-data/update'); ?>">
            <div class="card-body">
              <input type="hidden" name="id" value="<?php echo $data['id'];?>">
                <div class="form-group">
                    <label for="page_name">Page Name</label>
                    <input type="text" class="form-control" id="page_name" name="page_name" placeholder="Page Name" value="<?= isset($data['page_name']) ? $data['page_name'] : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="controller_name" name="controller_name" placeholder="Controller Name" value="<?= isset($data['controller_name']) ? $data['controller_name'] : '' ?>">
                    <?php if (isset($errors['controller_name'])) : ?>
                        <span class="text-danger"><?= $errors['controller_name'] ?></span>
                    <?php endif ?>
                </div>
                <div class="form-group">
                    <label for="title">Page Title</label>
                    <input type="text" class="form-control" id="title" name="page_title" placeholder="title" value="<?= isset($data['page_title']) ? $data['page_title'] : '' ?>">
                    <?php if (isset($errors['page_title'])) : ?>
                        <span class="text-danger"><?= $errors['page_title'] ?></span>
                    <?php endif ?>
                </div>
                <div class="form-group">
                    <label for="MetaKeyWord">Meta Key Word</label>
                    <input type="text" class="form-control" id="MetaKeyWord" name="meta_key_word" placeholder="meta key word" value="<?= isset($data['meta_key_word']) ? $data['meta_key_word'] : '' ?>">
